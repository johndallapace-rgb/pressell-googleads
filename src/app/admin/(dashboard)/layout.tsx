    ...
    <div className="min-h-screen bg-gray-50 flex font-sans">
      <aside className="w-72 bg-white border-r border-gray-200 min-h-screen fixed left-0 top-0 bottom-0 overflow-y-auto z-20 shadow-sm flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-1">
          ...
          <Link href="/admin/assets" className={`flex items-center px-4 py-3 rounded-lg transition-all duration-200 group ${isActive('/admin/assets')}`}>
            <svg className="w-5 h-5 mr-3 opacity-75 group-hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link href="/admin/scale" className={`flex items-center px-4 py-3 rounded-lg transition-all duration-200 group ${isActive('/admin/scale')}`}>
            <svg className="w-5 h-5 mr-3 opacity-75 group-hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link href="/admin/presell-factory" className={`flex items-center px-4 py-3 rounded-lg transition-all duration-200 group ${isActive('/admin/presell-factory')}`}>
            <svg className="w-5 h-5 mr-3 opacity-75 group-hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link href="/admin/config" className={`flex items-center px-4 py-3 rounded-lg transition-all duration-200 group ${isActive('/admin/config')}`}>
            <svg className="w-5 h-5 mr-3 opacity-75 group-hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link href="/admin/ai-engineering" className={`flex items-center px-4 py-3 rounded-lg transition-all duration-200 group ${isActive('/admin/ai-engineering')}`}>
            <svg className="w-5 h-5 mr-3 opacity-75 group-hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
