  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 p-6 rounded-lg">
         ...
         <div className="grid md:grid-cols-4 gap-4 items-end">
            <div className="md:col-span-2">
                <FormField>
                    <FormLabel className="text-xs text-blue-600 uppercase mb-1">Product / Niche Keyword</FormLabel>
                    <FormInput 
                        type="text" 
                        value={searchQuery} 
                        onChange={(e) => setSearchQuery(e.target.value)}
                        className="border-blue-200 text-black font-medium"
            ...
            <div>
                <FormField>
                    <FormLabel className="text-xs text-blue-600 uppercase mb-1">Target Country</FormLabel>
                    <FormSelect 
                        value={targetCountry} 
                        onChange={(e) => setTargetCountry(e.target.value)}
                        className="border-blue-200 text-black font-medium focus:ring-2 focus:ring-blue-500 outline-none bg-white"
                    >
            ...
            <div className="mb-4">
                <a 
                    ...
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex items-center justify-center gap-2 transition-colors h-[42px]"
                >
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        ...
        <div className="mb-6">
            <FormField>
                <FormLabel className="text-gray-700">Competitor Ad Copy (Paste here)</FormLabel>
                <FormTextarea 
                    value={competitorCopy}
                    onChange={(e) => setCompetitorCopy(e.target.value)}
                    className="h-48 font-mono bg-white text-black placeholder:text-gray-500 selection:bg-blue-200 selection:text-black shadow-sm"
